...
const jsAndWasmTemplate = {
    ...configTemplate,
    input: 'src/jsonc-lexer--js-and-wasm.js',
    output: {
        ...configTemplate.output,
        banner: banner`Combined JS and WASM build of jsonc-lexer.`,
        file: 'dist/jsonc-lexer--js-and-wasm.js',
    },
};

const jsOnlyTemplate = {
    ...configTemplate,
    input: 'src/jsonc-lexer--js-only.js',
    output: {
        ...configTemplate.output,
        banner: banner`JavaScript-only build of jsonc-lexer.`,
        file: 'dist/jsonc-lexer--js-only.js',
    },
};

const wasmOnlyTemplate = {
    ...configTemplate,
    input: 'src/jsonc-lexer--wasm-only.js',
    output: {
        ...configTemplate.output,
        banner: banner`WASM-only build of jsonc-lexer.`,
        file: 'dist/jsonc-lexer--wasm-only.js',
    },
};
...
const config = [
    ...
    },
    {
        ...
        output: {
            ...
            file: 'dist/jsonc-lexer--js-and-wasm.min.js',
        },
    ...
    },
    {
        ...
        output: {
            ...
            file: 'dist/jsonc-lexer--js-only.min.js',
        },
        plugins: [appendMinToBuildVariant(), terser()], // minified
    },
    ...
    },
    {
        ...
        output: {
            ...
            file: 'dist/jsonc-lexer--wasm-only.min.js',
        },
        plugins: [appendMinToBuildVariant(), terser()], // minified
    },
