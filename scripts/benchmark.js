...
import { jsoncLexer } from '../src/jsonc-lexer--js-and-wasm.js';
...
console.log(`Benchmarking jsonc-lexer v${version}`);
...
function ensureWasmAvailable() {
  try {
    jsoncLexer('{"warmup": true, /* comment */ "value": 1,}', { useWasm: 'always' });
  } catch (error) {
...
<head>
    ...
    <!-- Search engine meta -->
    <title>jsonc-lexer v${version} — Node.js benchmarks</title>
    <meta name="description"
        ...
        and different jsonc-lexer releases.">
    ...
    <meta property="og:url"
        content="https://richplastow.com/jsonc-lexer/bench-${version}.html">
    <meta property="og:image"
        content="https://richplastow.com/asset/logo/rich-plastow-logo-1200.png">
    <meta property="og:title" content="jsonc-lexer v${version} — Node.js benchmarks">
    ...
    <meta name="apple-mobile-web-app-title" content="jsonc-lexer">
    <meta name="application-name"           content="jsonc-lexer">
    <meta name="msapplication-config"       content="/asset/icon/browserconfig.xml">
    <meta name="theme-color"                content="#ffffff">
</head>
<body>
<header>
    <h1>jsonc-lexer v${version} — Node.js benchmarks</h1>
